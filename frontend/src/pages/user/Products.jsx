        ...
        {paginatedProducts.length > 0 ? (
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
            {paginatedProducts.map((product) => {
              ...
              return (
                <div key={product._id} className={`group bg-white rounded-2xl shadow-sm hover:shadow-xl transition-all duration-300 overflow-hidden border ${isOutOfStock ? 'border-red-100 opacity-75' : 'border-slate-100'}`}>
                  {/* Product Image */}
                  <Link to={`/product/${product._id}`} className="block relative overflow-hidden bg-slate-100">
                    ...
                    {/* Stock Status Badge - Priority over offer badge */}
                    {isOutOfStock ? (
                      <div className="absolute top-3 left-3 bg-red-600 text-white text-xs px-2.5 py-1 rounded-full flex items-center gap-1 z-10 font-semibold shadow-lg">
                        <X className="w-3 h-3" />
                        OUT OF STOCK
                      </div>
                    ) : (
                      <>
                        {/* Offer Badge - Show only if in stock */}
                        {hasDiscount && (
                  ...
                  <div className="p-4">
                    ...
                    <div className="mt-4 flex gap-2">
                      {isOutOfStock ? (
                        <>
                          <button
                            disabled
                            className="flex-1 bg-gray-300 text-gray-500 px-3 py-2 rounded-xl font-medium text-sm cursor-not-allowed flex items-center justify-center gap-2"
                          >
                          ...
                          <button
                            disabled
                            className="px-4 py-2 border-2 border-gray-300 text-gray-400 rounded-xl font-medium text-sm cursor-not-allowed"
                          >
                            Buy Now
                          </button>
                        </>
                        ...
                        <>
                          ...
                          <button
                            ...
                            className="px-4 py-2 border-2 border-indigo-600 text-indigo-600 rounded-xl font-medium text-sm hover:bg-indigo-50 transition-all"
                          >
                            Buy Now
                          </button>
                        </>
                    ...
                    {/* Best Offer Info - Only if in stock */}
                    {product.bestOffer && !isOutOfStock && (
                    ...
                    {isOutOfStock && (
                      <div className="mt-2 text-xs text-red-600 bg-red-50 rounded-lg p-1.5 text-center">
