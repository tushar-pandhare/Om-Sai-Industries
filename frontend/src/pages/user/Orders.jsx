...
//   const pendingOrders = orders?.filter(order => ['pending', 'processing', 'shipped', 'confirmed'].includes(order?.status)).length || 0;
...
//                       </div>
//                       <div>
//                         <p className="text-sm font-medium text-slate-800">Order {order?.status === 'confirmed' ? 'Confirmed' : 'Processing'}</p>
//                         <p className="text-xs text-slate-500">{formatDate(order?.updatedAt)}</p>
//                       </div>
//                     </div>
//                   )}
