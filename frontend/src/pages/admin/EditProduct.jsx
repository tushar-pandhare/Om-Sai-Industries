...
const EditProduct = () => {
  ...
  const handleImageSelect = (e) => {
    ...
    setImagePreviews([...imagePreviews, ...newPreviews]);
    setNewImageFiles([...newImageFiles, ...files]);
    toast.success(`${files.length} new image(s) added`);
  };
          ...
          <div className="flex items-center justify-between mb-2">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-gray-500 mt-1">Update product information and images</p>
              </div>
            </div>
            {/* Status indicator */}
            <div className="hidden sm:flex items-center gap-2 px-3 py-1.5 bg-blue-50 rounded-full">
              <div className="w-1.5 h-1.5 bg-blue-500 rounded-full animate-pulse"></div>
              <span className="text-xs text-blue-700 font-medium">Editing: {formData.name || 'Product'}</span>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="lg:col-span-2 space-y-6">
                    ...
                    <div className="flex items-end pb-3">
                      <div className="flex items-center gap-2">
                        {formData.stock > 10 ? (
                          ...
                          <span className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-xs font-medium bg-red-50 text-red-700 border border-red-200">
                            <AlertCircle className="h-3 w-3" />
                            Out of Stock
                          </span>
                        ) : null}
              ...
              <div className="bg-white rounded-2xl shadow-sm border border-gray-200 overflow-hidden hover:shadow-md transition-shadow duration-300">
                <div className="px-6 py-4 border-b border-gray-100 bg-gradient-to-r from-gray-50 to-white">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-gray-500">Manage product photos (max 10 images)</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="p-6">
                  {/* Upload Area */}
                  <div className="border-2 border-dashed border-gray-300 rounded-xl p-8 text-center hover:border-purple-400 hover:bg-purple-50/30 transition-all duration-300">
                    <input
                      type="file"
                      multiple
                      accept="image/jpeg,image/jpg,image/png,image/webp"
                  ...
                  {imagePreviews.length > 0 && (
                    <div className="mt-6">
                      <p className="text-sm font-medium text-gray-700 mb-3">
                        {imagePreviews.length} image(s) total - Click ✕ to remove
                      </p>
                      <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-4">
                        {imagePreviews.map((preview, idx) => (
                          <div key={idx} className="relative group">
                            ...
                            {idx < existingImages.length && (
                              <div className="absolute bottom-2 left-2 right-2 bg-blue-600/90 backdrop-blur-sm text-white text-xs text-center py-1 rounded-lg">
                                Existing
                              </div>
                            )}
                            {idx >= existingImages.length && (
                              <div className="absolute bottom-2 left-2 right-2 bg-green-600/90 backdrop-blur-sm text-white text-xs text-center py-1 rounded-lg">
                                New
                              </div>
                            )}
                          </div>
            ...
            <div className="lg:col-span-1 space-y-6">
              ...
              <div className="bg-gradient-to-br from-blue-50 to-indigo-50 rounded-2xl p-5 border border-blue-100">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <h4 className="font-semibold text-gray-900 text-sm">Update Tips</h4>
                    <ul className="text-xs text-gray-700 mt-2 space-y-1.5">
                      ...
                      <li className="flex items-start gap-1">
                        <span className="text-blue-500">•</span>
                        <span>Specifications help customer decisions</span>
                      </li>
                    </ul>
                  </div>
                </div>
